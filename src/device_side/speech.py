...
def say(text=""):
    ...
    with open('./device_side/speech/speech.mp3', 'wb') as handle:
        file = url.get(
    ...
    mixer.init()
    mixer.music.load('/home/pi/Documents/Python Programs/home-automation/src/device_side/speech/speech.mp3')
    mixer.music.play()
