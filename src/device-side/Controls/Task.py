...
class Task:
	...
	def execute_in_interval(self, interval_start, interval_end):
		"""
			Returns weather the task should be executed in a given interval
		...
		# Estimate the iteration that would be the end of the interval and the start of the interval, check the integer numer of iterations inbetween
